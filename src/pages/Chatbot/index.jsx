...
const Chatbot = () => {
  return (
    <Container>
      ...
      <MessagesContainer>
        <BotMessage>
          Seja bem-vinde! Sou assistente virtual da NOMEINDEFINIDO. Para começar precisaremos de algumas informações.  
          <br /><br />
        ...
        <BotMessage>
          Estamos gerando seu plano personalizado de estudos. Aguarde um momento. 
        </BotMessage>
